...
@Component({
  selector: 'app-upload-image-page3',
  templateUrl: './upload-image-page3.page.html',
  styleUrls: ['./upload-image-page3.page.scss'],
  standalone: false
})
export class UploadImagePage3Page implements AfterViewInit, OnDestroy {
