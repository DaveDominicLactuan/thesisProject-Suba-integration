...
@Component({
  selector: 'app-office-map-marker-page',
  templateUrl: './office-map-marker-page.page.html',
  styleUrls: ['./office-map-marker-page.page.scss'],
  standalone: false
})
export class OfficeMapMarkerPagePage implements OnInit, OnDestroy {
  ...
  sessions: any[] = [];
  officeLocationMarkers: any[] = []; // Office location markers for current user
